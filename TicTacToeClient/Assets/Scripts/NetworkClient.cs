...
public class NetworkClient : MonoBehaviour
{
    ...
    const string IPAddress = "192.168.2.53"; // local ip/ dam bell/ note its ip  IPv4 Address
    ...
    public void OnLoginButtonClicked()
    {
        ...
        {
            DisplayFeedback("Error: Please enter both a correct username and password.");
            return;
        }
    ...
    public void OnCreateAccountButtonClicked()
    {
        ...
        if (string.IsNullOrEmpty(username) || string.IsNullOrEmpty(password))
        {
            DisplayFeedback("Error: Please enter both Username and Password to create an account.");
            return;
        }
    ...
    {
        SendMessageToServer("PlayerMessage:Hello Player opponent!");
    }
    ...
    private void ProcessReceivedMsg(string msg)
    {
        ...
        if (msg.StartsWith("LoginSuccess"))
        {
            ...
            DisplayFeedback("Successfully Login!");
